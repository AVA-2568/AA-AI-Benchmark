...
面向**小说创作、日常问答、长文理解与纯文科推理**，剔除所有代码与终端指标，选取 10 个纯文本指标归入 4 大领域：

| 领域分类 (权重) | 1 个高难前沿主基准 (Major) | 2 个高覆盖辅助小基准 (Minors) | 子权重分配 |
|---|---|---|---|
| **创意写作与语言** (30%) | **EQ-Bench Creative** | | 60% |
| | | **LiveBench Language** | 40% |
| **事实准确性** (20%) | **Omniscience Index** | | 100% |
| **指令遵循与长上下文** (25%) | **LiveBench IF** | | 45% |
| | | **LCR** | 35% |
| | | **IFBench** | 20% |
| **终极科学与推理** (25%) | **HLE** | | 60% |
| | | **SciCode** | 25% |
| | | **LiveBench Reasoning** | 15% |
